...
test("npm run publish is a script runner, not a publish", () => {
  ...
  for (const optionValue of ["npm --tag run publish --ignore-scripts", "npm --workspace run publish --ignore-scripts", "npm --no-fund publish --ignore-scripts", "npm --fund publish --ignore-scripts"]) {
